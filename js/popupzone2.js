...
var popupzone ={
	...
	setBans:function(){
		...
		$("#prcontrol2 .btn-play").bind("click",function(){this_s.isPlay = true; $(this).hide(); $("#prcontrol2 .btn-stop").show(); this_s.setBanner(this_s.subSeq);});
		$("#prcontrol2 .btn-stop").bind("click",function(){this_s.isPlay = false; $(this).hide();$("#prcontrol2 .btn-play").show(); this_s.stopBan();});
		$("#prcontrol2 .btn-next").bind("click",function(){this_s.goNext();});
		$("#prcontrol2 .btn-prev").bind("click",function(){this_s.goPrev();});
